...
function allpay_accountlink_MetaData() {
    return array(
        'DisplayName' => '歐付寶 - 銀行快付',
...
function allpay_accountlink_config() {
    return array(
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => '銀行快付',
...
function allpay_accountlink_link($params) {
    # Invoice Variables
    $TimeStamp = time();
    ...
    $transaction = new AllPay_Pay('AccountLink');
    ...
    $transaction->ReturnURL = $systemurl.'/modules/gateways/callback/allpay_accountlink.php';
